...
#'
#' @description
#' This function uses the `ecmwfr` package to download ERA5-Land data for each site specified in the AmeriFlux site metadata data frame. The temporal and geographical coverage of the downloaded data will match the AmeriFlux site metadata data frame.
#'
...
#' @param mask (character) File path to the ERA5-Land land-sea mask. Get the mask with `get_land_sea_mask()`.
#' @param download_path (character) Path to the folder where the ERA5-Land data will get downloaded to.
#'
