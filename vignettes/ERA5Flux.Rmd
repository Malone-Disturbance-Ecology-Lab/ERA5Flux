...
This package was designed to make it easier to work with both [ERA5-Land](https://doi.org/10.24381/cds.e2161bac) and [AmeriFlux](https://ameriflux.lbl.gov/) data, hence the name "ERA5Flux". There may be instances where the AmeriFlux data contain gaps that you want to fill with ERA5-Land data to create a single time series for your analysis. 
